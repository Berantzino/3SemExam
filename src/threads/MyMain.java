package threads;// Used to schedule when certain events should be triggered
...
public class MyMain
{
    ...
    public static void addThreadsToPool()
    {
        ...
        eventPool.scheduleAtFixedRate(new GreetingThread(), 0, 1, SECONDS);
